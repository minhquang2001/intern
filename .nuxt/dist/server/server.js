...
/******/ 			var chunk = require("./" + ({"1":"components/wrapbutton","2":"components/wrapbutton-cy","3":"components/wrapcontent","4":"pages/index","5":"pages/index.cy"}[chunkId]||chunkId) + ".js");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return getNestedValue; });
/* unused harmony export deepEqual */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return getObjectValueByPath; });
/* unused harmony export getPropertyFromItem */
/* unused harmony export createRange */
/* unused harmony export getZIndex */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return filterObjectOnKeys; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return padEnd; });
...
/* harmony import */ var _framework__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);
...
function HexToRGBA(hex) {
  const rgba = Object(_helpers__WEBPACK_IMPORTED_MODULE_1__[/* chunk */ "a"])(hex.slice(1), 2).map(c => parseInt(c, 16));
  return {
    r: rgba[0],
    g: rgba[1],
    b: rgba[2],
...
function parseHex(hex) {
  ...
  if (hex.length === 6) {
    hex = Object(_helpers__WEBPACK_IMPORTED_MODULE_1__[/* padEnd */ "j"])(hex, 8, 'F');
  } else {
    hex = Object(_helpers__WEBPACK_IMPORTED_MODULE_1__[/* padEnd */ "j"])(Object(_helpers__WEBPACK_IMPORTED_MODULE_1__[/* padEnd */ "j"])(hex, 6), 8, 'F');
  }
...
class presets_Presets extends Service {
  constructor(parentPreset, parent) {
    ...
    const defaultPreset = Object(helpers["i" /* mergeDeep */])({}, default_preset); // The user provided preset
    ...
    parent.preset = Object(helpers["i" /* mergeDeep */])(Object(helpers["i" /* mergeDeep */])(defaultPreset, globalPreset), preset);
  }
}
...
class icons_Icons extends Service {
  constructor(preset) {
    ...
    this.values = Object(helpers["i" /* mergeDeep */])(presets[iconfont], values);
  }
}
...
function getTranslation(locale, key, usingDefault = false, defaultLocale) {
  ...
  let translation = Object(helpers["f" /* getObjectValueByPath */])(locale, shortKey, fallback);
...
function genStyles(theme, cssVar = false) {
  ...
  for (let i = 0; i < colors.length; ++i) {
    ...
    const variants = Object(helpers["h" /* keys */])(value);
...
class theme_Theme extends Service {
  ...
  get parsedTheme() {
    return parse(this.currentTheme || {}, undefined, Object(helpers["e" /* getNestedValue */])(this.options, ['variations'], true));
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(9).default("9593c05c", content, true)
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i){return i[1]});
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".wrap{border:1px solid;border-radius:50px;height:844px;margin:0 auto;width:390px}.wrap__content{flex-direction:column;height:100%}.wrap__content,.wrap__form{display:flex;justify-content:space-between}.wrap__form{align-items:center;background-color:#d9d9d9;margin:40px;padding:10px}.show{opacity:1;transition:opacity .2s ease-in-out}.hide{opacity:0;transition:opacity 1s ease-in-out}input{outline:none;padding:10px;width:80%}h1{font-size:2rem;margin:40px}", ""]);
// Exports
___CSS_LOADER_EXPORT___.locals = {};
module.exports = ___CSS_LOADER_EXPORT___;
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(9).default("520553ea", content, true)
...
__webpack_require__.d(components_namespaceObject, "WrapbuttonCy", function() { return WrapbuttonCy; });
__webpack_require__.d(components_namespaceObject, "Wrapbutton", function() { return Wrapbutton; });
__webpack_require__.d(components_namespaceObject, "Wrapcontent", function() { return Wrapcontent; });
...
const _0990e195 = () => interopDefault(__webpack_require__.e(/* import() | pages/index.cy */ 5).then(__webpack_require__.bind(null, 42)));
const _6fdc834c = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 4).then(__webpack_require__.bind(null, 41)));
...
const WrapbuttonCy = () => __webpack_require__.e(/* import() | components/wrapbutton-cy */ 2).then(__webpack_require__.bind(null, 43)).then(c => wrapFunctional(c.default || c));
const Wrapbutton = () => __webpack_require__.e(/* import() | components/wrapbutton */ 1).then(__webpack_require__.bind(null, 31)).then(c => wrapFunctional(c.default || c));
const Wrapcontent = () => __webpack_require__.e(/* import() | components/wrapcontent */ 3).then(__webpack_require__.bind(null, 44)).then(c => wrapFunctional(c.default || c));
...
var framework = __webpack_require__(7);
...
module.exports = require("@capacitor/clipboard");
